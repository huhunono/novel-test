...
def test_reg_login_empty_password_should_fail(plain_http) -> None:
    """
    ...
    """
    user_client = UserClient(plain_http)
    resp = user_client.login(
...
def test_reg_login_invalid_password_should_fail(plain_http):
    """
